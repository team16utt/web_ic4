                    ...
                    <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                        <div class="product-image">
                            ...
                            <div class="product_img_box">
                                <img id="product_img" src='<?= $productDetail->images[0]->imageThumb ?>'
                                    data-zoom-image="<?= $productDetail->images[0]->imageThumb ?>" alt="<?= $productDetail->name ?>">
                                <a href="#" class="product_img_zoom" title="Zoom">
                                    <span class="linearicons-zoom-in"></span>
                                </a>
                            </div>
                            <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4"
                                data-slides-to-scroll="2" data-infinite="false">
                                <?php foreach ($productDetail->images as $image) : ?>
                                <div class="item">
                                    <a href="#" class="product_gallery_item"
                                        data-image="<?= $image->imageThumb ?>"
                                        data-zoom-image="<?= $image->imageThumb ?>">
