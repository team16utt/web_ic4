                            ...
                            <div class="cart_box dropdown-menu dropdown-menu-right">
                                <ul class="cart_list">
                                    <li>
                                        ...
                                        <a href="#"><img src="<?= base_url() ?>/public/client/assets/images/cart_thamb1.jpg" alt="cart_thumb1">Variable product 001</a>
                                        <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>78.00</span>
                                    </li>
                                    <li>
                                        <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                        <a href="#"><img src="<?= base_url() ?>/public/client/assets/images/cart_thamb2.jpg" alt="cart_thumb2">Ornare sed consequat</a>
                        ...
                        <div class="login_wrap">
                            ...
                            <?php if(isset($_GET['status']) ){
                                ...
                                <form action="signup/register" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="phone" required="" class="form-control" name="phonenumber" placeholder="Enter Your Phone Number">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="login_footer form-group">
                                        <div class="chek-form">
                                            <div class="custome-checkbox">
                                                <input class="form-check-input" required type="checkbox" name="checkbox"
                                ...
                                <div class="form-note text-center">Already have an account? <a href="login.html">Log
                                        in</a></div>
                            </div>
                        </div>
                    </div>
