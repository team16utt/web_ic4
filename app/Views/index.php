                    ...
                    <div class="banner_section shop_el_slider">
                        <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active background_bg" data-img-src="<?= base_url() ?>/public/client/assets/images/blog_img3.jpg">
                                                ...
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            ...
                                                            <img class="product_hover_img" src="<?= base_url() ?>/public/client/assets/images/el_hover_img10.jpg" alt="el_hover_img10">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To
                                                    ...
                                                    <div class="product_info">
                                                        <h6 class="product_title"><a href="shop-product-detail.html">classical Headphone</a>
                                                        </h6>
                                                        <div class="product_price">
                                                            <span class="price">$68.00</span>
                                                            <del>$99.00</del>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="client_logo carousel_slider owl-carousel owl-theme nav_style3" data-dots="false" data-nav="true" data-margin="30" data-loop="true" data-autoplay="true" data-responsive='{"0":{"items": "2"}, "480":{"items": "3"}, "767":{"items": "4"}, "991":{"items": "5"}, "1199":{"items": "6"}}'>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_razer.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_logitech.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_edra.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_dareu.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_corsair.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_zowie.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_asus.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_samsung.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>/public/client/assets/images/cl_logo_thinkpad.png" alt="cl_logo">
                                </div>
                            </div>
                        </div>
                    </div>
