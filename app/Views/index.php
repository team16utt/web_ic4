            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-5">
                            <div class="background_bg h-100" data-img-src="<?= base_url() ?>//assets/images/popup_img3.jpg"></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active background_bg"
                                    data-img-src="<?= base_url() ?>//assets/images/blog_img3.jpg">
                                ...
                                <div class="carousel-item background_bg" data-img-src="<?= base_url() ?>//assets/images/banner14.jpg">
                                    <div class="banner_slide_content banner_content_inner">
                                ...
                                <div class="carousel-item background_bg" data-img-src="<?= base_url() ?>//assets/images/banner15.jpg">
                                    <div class="banner_slide_content banner_content_inner">
                                        <div class="col-lg-8 col-10">
                                            <div class="banner_content3 overflow-hidden">
                                                <h5 class="mb-3 staggered-animation font-weight-light"
                ...
                <div class="col-lg-2 d-none d-lg-block">
                    <div class="shop_banner2 el_banner1">
                        <a href="#" class="hover_effect1">
                            ...
                            <div class="el_img">
                                <img src="<?= base_url() ?>//assets/images/shop_banner_img6.png" alt="shop_banner_img6">
                            </div>
                        </a>
                    </div>
                    <div class="shop_banner2 el_banner2">
                        <a href="#" class="hover_effect1">
                            ...
                            <div class="el_img">
                                <img src="<?= base_url() ?>//assets/images/shop_banner_img7.png" alt="shop_banner_img7">
                            </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="col-xl-3 d-none d-xl-block">
                        <div class="sale-banner">
                            <a class="hover_effect1" href="#">
                                <img src="<?= base_url() ?>//assets/images/logitechtest.png" alt="shop_banner_img6">
                            </a>
                        </div>
                    </div>
                    <div class="col-xl-9">
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img1.jpg" alt="el_img1">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1"
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img7.jpg" alt="el_img7">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img7.jpg"
                                                                alt="el_hover_img7">
                                                        </a>
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img8.jpg" alt="el_img8">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img8.jpg"
                                                                alt="el_hover_img8">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img9.jpg" alt="el_img9">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img9.jpg"
                                                                alt="el_hover_img9">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img10.jpg" alt="el_img10">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img10.jpg"
                                                                alt="el_hover_img10">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img11.jpg" alt="el_img11">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img11.jpg"
                                                                alt="el_hover_img11">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img12.jpg" alt="el_img12">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img12.jpg"
                                                                alt="el_hover_img12">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                        ...
                                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1"
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img4.jpg" alt="el_img4">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img4.jpg"
                                                                alt="el_hover_img4">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                                ...
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img1.jpg" alt="el_img1">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img1.jpg"
                                                                alt="el_hover_img1">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img6.jpg" alt="el_img6">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img6.jpg"
                                                                alt="el_hover_img6">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                        ...
                                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1"
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img2.jpg" alt="el_img2">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img2.jpg"
                                                                alt="el_hover_img2">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
                                            ...
                                            <div class="item">
                                                <div class="product_wrap">
                                                    <div class="product_img">
                                                        <a href="shop-product-detail.html">
                                                            <img src="<?= base_url() ?>//assets/images/el_img5.jpg" alt="el_img5">
                                                            <img class="product_hover_img"
                                                                src="<?= base_url() ?>//assets/images/el_hover_img5.jpg"
                                                                alt="el_hover_img5">
                                                        </a>
                                                        <div class="product_action_box">
                                                            <ul class="list_none pr_action_btn">
            ...
            <div class="custom-container">
                <div class="row">
                    <div class="col-xl-3 d-none d-xl-block">
                        <div class="sale-banner">
                            <a class="hover_effect1" href="#">
                                <img src="<?= base_url() ?>//assets/images/shop_banner_img10.jpg" alt="shop_banner_img10">
                            </a>
                        </div>
                    </div>
                    <div class="col-xl-9">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img2.jpg" alt="el_img2">
                                                    <img class="product_hover_img" src="<?= base_url() ?>//assets/images/el_hover_img2.jpg"
                                                        alt="el_hover_img2">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img5.jpg" alt="el_img5">
                                                    <img class="product_hover_img" src="<?= base_url() ?>//assets/images/el_hover_img5.jpg"
                                                        alt="el_hover_img5">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img9.jpg" alt="el_img9">
                                                    <img class="product_hover_img" src="<?= base_url() ?>//assets/images/el_hover_img9.jpg"
                                                        alt="el_hover_img9">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img7.jpg" alt="el_img7">
                                                    <img class="product_hover_img" src="<?= base_url() ?>//assets/images/el_hover_img7.jpg"
                                                        alt="el_hover_img7">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img12.jpg" alt="el_img12">
                                                    <img class="product_hover_img"
                                                        src="<?= base_url() ?>//assets/images/el_hover_img12.jpg" alt="el_hover_img12">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="client_logo carousel_slider owl-carousel owl-theme nav_style3" data-dots="false"
                            ...
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>//assets/images/cl_logo1.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>//assets/images/cl_logo2.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>//assets/images/cl_logo3.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>//assets/images/cl_logo4.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>//assets/images/cl_logo5.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>//assets/images/cl_logo6.png" alt="cl_logo">
                                </div>
                            </div>
                            <div class="item">
                                <div class="cl_logo">
                                    <img src="<?= base_url() ?>//assets/images/cl_logo7.png" alt="cl_logo">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img4.jpg" alt="el_img4">
                                                    <img class="product_hover_img" src="<?= base_url() ?>//assets/images/el_hover_img4.jpg"
                                                        alt="el_hover_img4">
                                                </a>
                                            </div>
                                            <div class="product_info">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img6.jpg" alt="el_img6">
                                                    <img class="product_hover_img" src="<?= base_url() ?>//assets/images/el_hover_img6.jpg"
                                                        alt="el_hover_img6">
                                                </a>
                                            </div>
                                            <div class="product_info">
                                        ...
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img8.jpg" alt="el_img8">
                                                    <img class="product_hover_img" src="<?= base_url() ?>//assets/images/el_hover_img8.jpg"
                                                        alt="el_hover_img8">
                                                </a>
                                            </div>
                                            <div class="product_info">
                                        ...
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img10.jpg" alt="el_img10">
                                                    <img class="product_hover_img"
                                                        src="<?= base_url() ?>//assets/images/el_hover_img10.jpg" alt="el_hover_img10">
                                                </a>
                                            </div>
                                            <div class="product_info">
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img11.jpg" alt="el_img11">
                                                    <img class="product_hover_img"
                                                        src="<?= base_url() ?>//assets/images/el_hover_img11.jpg" alt="el_hover_img11">
                                                </a>
                                            </div>
                                            <div class="product_info">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="<?= base_url() ?>//assets/images/el_img1.jpg" alt="el_img1">
                                                    <img class="product_hover_img" src="<?= base_url() ?>//assets/images/el_hover_img1.jpg"
                                                        alt="el_hover_img1">
                                                </a>
                                            </div>
                                            <div class="product_info">
